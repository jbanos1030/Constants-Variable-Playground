...
*/
// there was a mistake when plugging the name in
// instead of coding "score for rob" it indicated "score for red" which had to be changed in order for it to mark the same amount of points since they shot the same targets
// its easy to commit a mistake so it's important to look back at everything we do
